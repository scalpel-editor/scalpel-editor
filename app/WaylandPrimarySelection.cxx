...
void WaylandPrimarySelection::AppendPollDescriptors(
	std::vector<pollfd> &descriptors) const {
...
void WaylandPrimarySelection::ProcessPollDescriptors(
	const std::vector<pollfd> &descriptors, std::size_t firstDescriptor) {
