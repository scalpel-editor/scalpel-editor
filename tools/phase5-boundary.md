...
| `TextWidth` | `uptr_t style, const char *text` | `int style, const char *text` |
| `SearchText` | `EditorCommand, uptr_t flags, sptr_t text` | `EditorCommand, FindOption flags, const char *text` |
...
- `//++Autogenerated` / generated-section markers
...
| Autogenerated section markers | ~18 |
