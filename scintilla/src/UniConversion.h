...
// UTF-8 to UTF-16/32 length and conversion treat each invalid byte as one code unit
// and always advance, matching the document invalid-UTF-8 one-byte-character policy.
// They must not skip following bytes after a truncated multi-byte lead.
