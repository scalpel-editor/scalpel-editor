...
4. Make layout consume shaped runs. Implement screen-line layout, byte-position measurement, wrapping widths, hit testing, selection intervals, and caret movement from the same cached result, including tabs and Scintilla representations. Focused editor tests prove that byte positions and valid caret stops agree at cluster boundaries before drawing is added.
