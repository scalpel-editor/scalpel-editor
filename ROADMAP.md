...
1. Freeze the Phase 6 boundary and dependencies. Inventory the `Platform.h` operations the editor still uses, assign each to the renderer, minimal shell, or explicit popup stub, and record the Wayland, xdg-shell, EGL, OpenGL, xkbcommon, FreeType, HarfBuzz, Fontconfig, protocol-generation, source-reference, and license requirements. Keep compose, repeat, IME, clipboard, primary selection, cursor themes, frame pacing, presentation feedback, optional-protocol fallback, and scale changes in phase 7.
