...
3. Complete toplevel and pointer behavior. Add xdg-decoration negotiation and retained xdg-toplevel state, consume current pointer-axis frame events without double-counting compatibility events, and test compositor-driven capability and lifecycle changes.
