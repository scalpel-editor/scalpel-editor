...
3. Implement the shaped-run model and cache. Shape directional runs with HarfBuzz, disable discretionary ligatures, split fallback spans without losing input-byte offsets, and cache glyph IDs, advances, offsets, byte clusters, caret stops, font faces, and direction. Tests cover ASCII, kerning pairs, combining sequences, invalid UTF-8, required left-to-right shaping, and deterministic font fallback; mixed-direction line ordering remains out of scope.
