...
6. Add clipboard transfers. Implement asynchronous UTF-8 offers, MIME selection, reads, writes, cancellation, source lifetime, and nonblocking file-descriptor integration, then replace the production editor host's unsupported clipboard paths with observable success and failure behavior.
