...
2. Establish deterministic font fixtures and ownership. Check in a compatibly licensed primary and fallback test font with license notices; add Fontconfig lookup for production fonts and explicit paths for tests; define clear lifetime and cache ownership for Fontconfig matches, FreeType faces, HarfBuzz fonts, and fallback faces. Focused tests cover metrics, requested style and weight, missing-family fallback, and stable fixture selection.
