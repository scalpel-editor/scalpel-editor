...
10. Make scaling coherent. Track output entry and removal, integer buffer scale, fractional scale, and viewporter state; update EGL buffers and editor geometry together; and test that pointer, caret, font, cursor, damage, surface, and buffer coordinates remain aligned across live scale changes and optional-protocol fallbacks.
