...
7. Add primary selection. Bind the optional primary-selection protocol when available, connect selection ownership and middle-button paste to the editor, share only the transfer mechanics that are genuinely common with the clipboard, and retain tested behavior when the protocol is absent.
