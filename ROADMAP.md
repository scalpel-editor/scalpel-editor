...
11. Prepare the event loop for portal dialogs. Absorb asynchronous D-Bus watches and timers plus the xdg-foreign parent handle needed by Phase 8, while leaving open/save choices and file-dialog policy to the application phase.
