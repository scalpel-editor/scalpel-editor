...
9. Pace and report frames. Drive redraw submission with `wl_surface.frame`, track damage for EGL buffer swaps, use presentation-time only to report when a submitted frame appeared, and ensure invalidation arriving during an outstanding frame is not lost.
