...
5. Add themed cursors. Load and scale cursor themes, map every editor cursor to an available Wayland cursor with clear fallbacks, update cursor surfaces on pointer entry and editor requests, and cleanly rebuild them when seat or scale state changes.
