...
8. Add text-input-v3 IME support. Enable and disable text input with keyboard focus, synchronize surrounding text and cursor rectangles, route pre-edit, commit, and deletion into the retained editor IME operations, and test ordering, cancellation, and absence of the optional protocol.
