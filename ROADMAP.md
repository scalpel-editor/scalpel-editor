...
4. Complete keyboard input. Add locale-aware xkbcommon compose and compositor-configured key repeat, integrate repeat deadlines into the existing event loop, cancel them on release or focus and seat loss, and test command keys, composed text, and repeat timing independently of a compositor.
