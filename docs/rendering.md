...
The application coordinator currently owns the chrome models, input priority, active overlay, and painter binding. Individual controls own their layout, hit testing, interaction state, and paint operations without a widget hierarchy.
